...
class TreeOutput {
    ...
    public function add($value){
        $this->buf .= 'this.append(\'';
        $this->buf .= (string) $value;
        $this->buf .= '\');';
        $this->buf .= PHP_EOL;
    }
    public function up(){
        $this->buf .= 'this.pop();' . PHP_EOL;
    }
    public function down(){
        $this->buf .= 'this.push();' . PHP_EOL;
    }
    public function writeln($value){
        $this->buf .= (string) $value . PHP_EOL;
    }
    public function prefix(){
        $this->buf .= 'var treeDef = function (){' . PHP_EOL;
    }
...
class JSExchange implements IExchange {
    ...
    public function visitInterfaceTokenMeta(InterfaceTokenMetaData $meta){
        $buf = new TreeOutput;
        $buf->add('[' . $meta->getNodeName() . ': ' . $meta->getValue()  . ']');
        return $buf;
    }
    public function visitClassTokenMeta(ClassTokenMetaData $meta){
        $buf = new TreeOutput;
